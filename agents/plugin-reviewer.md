...
- Shared doc references use `${CLAUDE_PLUGIN_ROOT}/skills/shared/_<name>.md`.
...
- Every shared doc referenced via `${CLAUDE_PLUGIN_ROOT}/skills/shared/_<name>.md` exists in `skills/shared/`.
