...
- **Baseline (always):** `**/controller*`, `**/handler*`, `**/routes/**`, `**/route*`, `**/*Repository*`, `**/*Dao*`, `**/api/**`
- **dotnet:** `**/Controllers/**`, `**/Handlers/**`, `**/*DbContext*`, `**/*Query*`
- **node / vue:** `**/*.controller.*`, `**/*.resolver.*`
- **python:** `**/views.py`, `**/urls.py`, `**/*_view.py`

**Deep mode file targets**: all of the above (baseline + selected stacks) plus `**/Middleware/**`, `**/middleware*`, `**/Utils/**`, `**/Helpers/**`, `**/Services/**`, `**/service*`, `**/shared/**`
